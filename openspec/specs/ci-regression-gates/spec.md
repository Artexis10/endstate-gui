# ci-regression-gates Specification

## Purpose
Defines the layered, fail-closed pull-request and release-automation gates that protect production web assets, Rust dependency state, engine resources, and Windows installer bundles without running expensive packaging for unrelated changes.
## Requirements
