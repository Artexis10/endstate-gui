...
- **AND** it does not claim that any backup is current or up to date without version evidence
...
- **AND** its descriptive copy limits the cross-device scope to an Endstate application list and supported non-secret settings on another Windows PC
